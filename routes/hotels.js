...
router.put(
  "/:hotelId/user/:userId",
  authorize(role.HotelManager),
  hotelController.addRoomToHotel
);
...
router.get(
  ...
  authorize([role.HotelManager, role.Admin, role.Guest]),
  hotelController.getHotelsWithRooms
);
...
router.get(
  "/:userid/:hotelid",
  authorize(role.HotelManager),
  hotelController.getRoomsFromHotelID
);

/*GET available rooms*/
router.get(
  "/available/:userid/:hotelid",
  authorize(role.User),
  hotelController.getAvailableRoomsFromHotelid
);
